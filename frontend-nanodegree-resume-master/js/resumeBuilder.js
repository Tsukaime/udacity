...
var project = {
    ...
    "onlineClasses" : {
        ...
        "display" : function() {
            ...
            var formattedSchoolsMajors = HTMLschoolMajors.replace("%data%", education.schools.majors);
            ...
            var formattedOnlineDate = HTMLonlineDate.replace("%data%", education.onlineClasses.date);
